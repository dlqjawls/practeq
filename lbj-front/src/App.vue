  ...
  <v-app>
    ...
    <div class="netflix-logo">
      ...
      <div v-if="store.username" class="user-info">
        <img v-if="store.profile-picture" :src="store.profilePicture" alt="프로필 사진" class="profile-image" />
        <img v-else="!store.profile-picture" src="/uknowgimozzi.jpg" alt="노사진" class="profile-image"/>
...
.profile-image {
  ...
  object-fit: cover; /* 이미지 비율 유지하며 영역을 채움 */
  border: 0.1px solid #ff0050; /* 빨간색 경계선 추가 */
